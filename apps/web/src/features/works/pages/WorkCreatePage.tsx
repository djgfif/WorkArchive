...
export function WorkCreatePage() {
  ...
  const initialMode =
    searchParams.get('mode') === 'manual' ? 'manual' : 'search';
  ...
  return (
    <FlowPageTemplate>
      <PageHero title={t('works.add.title')} titleAs="h1" />
