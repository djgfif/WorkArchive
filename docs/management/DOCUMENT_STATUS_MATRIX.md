...
This table separates current docs from archived reference material.

## Status Definitions

- `canonical`: current source of truth.
- `active`: current supporting document.
- `archived`: retained for context, not current direction.
