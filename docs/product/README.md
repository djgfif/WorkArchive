...
이 폴더는 현재 구현 설명이 아니라 **제품 비전, near-term roadmap, 확장 전략**을 다룬다.

## Read In This Order

1. [`COMMERCIAL_WEB_DESIGN_IMPLEMENTATION_PLAN.md`](./COMMERCIAL_WEB_DESIGN_IMPLEMENTATION_PLAN.md)
2. [`FINAL_WEB_DESIGN.md`](./FINAL_WEB_DESIGN.md)
3. [`CLEAN_PROFESSIONAL_WEB_UI_SYSTEM.md`](./CLEAN_PROFESSIONAL_WEB_UI_SYSTEM.md)
4. [`AUTH_AND_GUEST_EXPERIENCE_STRATEGY.md`](./AUTH_AND_GUEST_EXPERIENCE_STRATEGY.md)
5. [`VERIFIED_CATALOG_PROMOTION_ARCHITECTURE.md`](./VERIFIED_CATALOG_PROMOTION_ARCHITECTURE.md)
6. 아래의 `Tier Board MVP Strategy`
7. 아래의 `Tier Board Domain Model Draft`

## Document Roles

| Document | Role |
| --- | --- |
| [`COMMERCIAL_WEB_DESIGN_IMPLEMENTATION_PLAN.md`](./COMMERCIAL_WEB_DESIGN_IMPLEMENTATION_PLAN.md) | 근거리 제품/프론트 로드맵 |
